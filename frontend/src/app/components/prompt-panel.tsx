  ...
  return (
    <div className="h-full flex flex-col bg-white">
      ...
      <div className="p-4 border-b border-[#D8D8E5] bg-[#FAFCFA]">
        ...
        <p className="text-xs text-[#575758]">Interact with the Pydantic AI-powered AI agent for portfolio visualization and analysis</p>

        {/* Available Cash Display */}
        <div className="mt-3 p-2 bg-[#e92063]/10 rounded-lg">
      ...
      <CopilotChat className="h-[78vh] p-2" labels={
        {
          initial : `I am a Pydantic AI agent designed to analyze investment opportunities and track stock performance over time. How can I help you with your investment query? For example, you can ask me to analyze a stock like "Invest in Apple with 10k dollars since Jan 2023". \n\nNote: The AI agent has access to stock data from the past 4 years only`
        }
      } />
