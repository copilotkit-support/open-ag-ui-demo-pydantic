    ...
    <div className="flex items-center justify-between">
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-2 group">
          <div className="w-8 h-8 bg-[#e92063] rounded-full flex items-center justify-center">
        ...
        <div className="flex items-center gap-2">
          <div
            className={`w-8 h-8 rounded-full flex items-center justify-center ${
              fourYearReturn >= 0 ? "bg-[#e92063]" : "bg-red-100"
            }`}
          >
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="w-20 h-2 bg-[#E8E8EF] rounded-full overflow-hidden">
          <div
            className="h-full bg-gradient-to-r from-[#e92063] to-[#BEC9FF] transition-all duration-300"
